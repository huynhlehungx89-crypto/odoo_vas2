# -*- coding: utf-8 -*-
"""Wizard lập B03 → lưu vas.report.snapshot."""
from odoo import api, fields, models, _
from odoo.exceptions import UserError


class VasB03Wizard(models.TransientModel):
    _name = 'vas.b03.wizard'
    _description = 'Lập báo cáo lưu chuyển tiền tệ VAS (B03-DNN)'
